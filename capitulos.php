        ...
        <div class="content">
            <div class="intro-y flex items-center mt-8">
                <h2 class="text-lg font-medium mr-auto">
                    Todos los capítulos y mangas
                </h2>
            </div>
            <div class="">
                <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                    <a href="nuevo_capitulo" class="btn btn-primary shadow-md mr-2">Agregar nuevo</a>
                    <div class="dropdown">
                        <a href="nuevo_capitulo" class="dropdown-toggle btn px-2 box" aria-expanded="false" data-tw-toggle="dropdown">
                    ...
                    <div class="hidden md:block mx-auto text-slate-500">Viendo 1 al 10 de 150 vistas</div>
                ...
                <div class="serie_contenedor">
                    ...
                    $sql = "SELECT `capitulo`.*, `series`.*
                    FROM `capitulo`
                    INNER JOIN `series` ON `capitulo`.`serie_id` = `series`.`id`
                    WHERE `capitulo`.`serie_id` = `series`.`id`;                    
                    ";
                            ...
                            <div class="box  mt-3 mb-3 box_serie">
                                <div class="p-5">
                                    <div class="h-40 2xl:h-56 image-fit rounded-md overflow-hidden before:block before:absolute before:w-full before:h-full before:top-0 before:left-0 before:z-10 before:bg-gradient-to-t before:from-black before:to-black/10">
                                        ...
                                        <span class="absolute top-0 bg-pending/80 text-white text-xs m-5 px-2 py-1 rounded z-10">E</span>
                                        <div class="absolute bottom-0 text-white px-5 pb-6 z-10"> <a href="" class="block font-medium text-base"><?php echo $name_cap ?></a> <span class="text-white/90 text-xs mt-3"><?php echo $row['nombre_de_la_serie'] ?></span> </div>
                                    </div>
                                    <div class="text-slate-600 dark:text-slate-500 mt-5">
                                        ...
                                        <div class="flex items-center mt-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="calendar" data-lucide="calendar" class="lucide lucide-link w-4 h-4 mr-2">
                                ...
                                <div class="flex justify-center lg:justify-end items-center p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                                    <!-- href="ver_cap.php?id=<?php echo $row['id_cap'] ?>">  -->
                                    <button onclick="verCap(<?php echo $row['id_cap']; ?>)"  class="flex items-center text-primary mr-auto">
