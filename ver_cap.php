                            ...
                            <div class="p-5">
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="grid grid-cols-12 gap-2">
                                        <p class="col-span-6">
                                            <?php include('ver_cap_designaciones.php');
                                                include('./icomoon/logic/conexion.php');
                                                $db = $conn;
                                                mostrarRoles("Editores", "editores",  "editor_id", $id_cap, $db);

                                                $usuarioRoles = obtenerRolesUsuario($_SESSION['userid'], $db);

                                                if (in_array("Editores", $usuarioRoles)) {
                                                    mostrarRoles("Editores", "editores", "editor_id", $id_cap, $db);
                                                } else {
                                                    echo "No tienes permisos como Editor";
                                                }
                                            ?>
                                        </p>
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="grid grid-cols-12 gap-2">
                                        <p class="col-span-6">
                                            <?php
                                                mostrarRoles("traductor", "traductores",  "traductor_id", $id_cap, $db);
                                            ?>
                                        </p>
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="grid grid-cols-12 gap-2">
                                        <p class="col-span-6">
                                            <?php
                                                mostrarRoles("limpiador", "limpieza",  "limpieza_id", $id_cap, $db);
                                            ?>
                                        </p>
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="grid grid-cols-12 gap-2">
                                        <p class="col-span-6">
                                            <?php
                                                $db = $conn;
                                                mostrarRoles("Corrector", "corrector",  "corrector_id", $id_cap, $db);

                                                $usuarioRoles = obtenerRolesUsuario($_SESSION['userid'], $db);

                                                if (in_array("Corrector", $usuarioRoles)) {
                                                    mostrarRoles("Corrector", "corrector", "corrector_id", $id_cap, $db);
                                                } else {
                                                    echo "No tienes permisos como Corrector";
                                                }
                                            ?>
                                        </p>
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="grid grid-cols-12 gap-2">
                                        <p class="col-span-6">
                                            <?php
                                                mostrarRoles("Desensurador", "desensurador",  "desensurador_id", $id_cap, $db);
                                            ?>
                                        </p>
