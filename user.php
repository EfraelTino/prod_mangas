...
<body class="py-5 md:py-0">
    ...
    <!-- BEGIN: Top Bar -->
   <?php
    $nombre_ruta= 'Todos los usuarios';
   ...
   ?>
            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                ...
                <div class="intro-y col-span-12 md:col-span-6 lg:col-span-4">
                    <div class="box">
                        ...
                        <div class="text-center lg:text-left p-5">
                            ...
                            <div class="flex items-center justify-center lg:justify-start text-slate-500 mt-5"> <i data-lucide="mail" class="w-3 h-3 mr-2"></i> christianbale@left4code.com </div>
                            <div class="flex items-center justify-center lg:justify-start text-slate-500 mt-1"> <i data-lucide="instagram" class="w-3 h-3 mr-2"></i> Christian Bale </div>
                        </div>
                ...
                <div class="intro-y col-span-12 md:col-span-6 lg:col-span-4">
                    <div class="box">
                        ...
                        <div class="text-center lg:text-left p-5">
                            <div>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem </div>
                            <div class="flex items-center justify-center lg:justify-start text-slate-500 mt-5"> <i data-lucide="mail" class="w-3 h-3 mr-2"></i> russellcrowe@left4code.com </div>
                            <div class="flex items-center justify-center lg:justify-start text-slate-500 mt-1"> <i data-lucide="instagram" class="w-3 h-3 mr-2"></i> Russell Crowe </div>
                        </div>
                        <div class="text-center lg:text-right p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                            <button class="btn btn-primary py-1 px-2 mr-2">Message</button>
                            <button class="btn btn-outline-secondary py-1 px-2">Profile</button>
                ...
                <div class="intro-y col-span-12 md:col-span-6 lg:col-span-4">
                    <div class="box">
                        <div class="flex items-start px-5 pt-5">
                            <div class="w-full flex flex-col lg:flex-row items-center">
                                <div class="w-16 h-16 image-fit">
                                    <img alt="Midone - HTML Admin Template" class="rounded-full" src="images/profile-5.jpg">
                                </div>
                                <div class="lg:ml-4 text-center lg:text-left mt-3 lg:mt-0">
                                    <a href="" class="font-medium">Russell Crowe</a>
                ...
                <div class="intro-y col-span-12 md:col-span-6 lg:col-span-4">
                    <div class="box">
                        <div class="flex items-start px-5 pt-5">
                            <div class="w-full flex flex-col lg:flex-row items-center">
                                <div class="w-16 h-16 image-fit">
                                    <img alt="Midone - HTML Admin Template" class="rounded-full" src="images/profile-11.jpg">
                                </div>
                                <div class="lg:ml-4 text-center lg:text-left mt-3 lg:mt-0">
                ...
                <div class="intro-y col-span-12 md:col-span-6 lg:col-span-4">
                    <div class="box">
                        ...
                        <div class="text-center lg:text-left p-5">
                            <div>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomi</div>
                            <div class="flex items-center justify-center lg:justify-start text-slate-500 mt-5"> <i data-lucide="mail" class="w-3 h-3 mr-2"></i> charlizetheron@left4code.com </div>
                            <div class="flex items-center justify-center lg:justify-start text-slate-500 mt-1"> <i data-lucide="instagram" class="w-3 h-3 mr-2"></i> Charlize Theron </div>
                        </div>
                        <div class="text-center lg:text-right p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                            <button class="btn btn-primary py-1 px-2 mr-2">Message</button>
                            <button class="btn btn-outline-secondary py-1 px-2">Profile</button>
    ...
    <div data-url="side-menu-light-users-layout-3.html" class="dark-mode-switcher cursor-pointer shadow-md fixed bottom-0 right-0 box dark:bg-dark-2 border rounded-full w-40 h-12 flex items-center justify-center z-50 mb-10 mr-10">
