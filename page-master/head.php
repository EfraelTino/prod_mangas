...
<head>
    ...
    <!-- Favicones -->
    <link href="https://puntoarcade.com/textures/favicon.ico" rel="shortcut icon" type="image/x-icon">
    <link rel="icon" href="https://puntoarcade.com/textures/favicon.ico" type="image/x-icon">
    <link rel="shortcut icon" href="https://puntoarcade.com/textures/favicon.ico" type="image/x-icon">
    ...
    <!-- CSS General -->
    <link rel="stylesheet" href="conectado.css">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Titillium+Web:ital,wght@0,200;0,300;0,400;0,600;0,700;0,900;1,700&family=Turret+Road:wght@200;300;400;500;700;800&display=swap" rel="stylesheet"> -->
