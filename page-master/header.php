...
<div class="top-bar-boxed h-[70px] md:h-[65px] z-[51] border-b border-white/[0.08] mt-12 md:mt-0 -mx-3 sm:-mx-8 md:-mx-0 px-3 md:border-b-0 relative md:fixed md:inset-x-0 md:top-0 sm:px-8 md:px-10 md:pt-10 md:bg-gradient-to-b md:from-slate-100 md:to-transparent dark:md:from-darkmode-700">
    <div class="h-full flex items-center">
        ...
        <a href="" class="logo -intro-x hidden md:flex xl:w-[180px] block">
            <img alt="Midone - HTML Admin Template" class="logo__image w-6" src="images/logo.svg">
        ...
        <nav aria-label="breadcrumb" class="-intro-x h-[45px] mr-auto">
            <ol class="breadcrumb breadcrumb-light">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?php echo $nombre_ruta; ?></li>
            </ol>
        </nav>
        <!-- END: Breadcrumb -->
        <!-- BEGIN: Search -->
                    ...
                    <div class="search-result">
                        <div class="search-result__content">
                            ...
                            <div class="mb-5">
                                ...
                                <a href="" class="flex items-center mt-2">
                                    <div class="w-8 h-8 image-fit">
                                        <img alt="Midone - HTML Admin Template" class="rounded-full" src="images/profile-7.jpg">
                                    </div>
                                ...
                                <a href="" class="flex items-center mt-2">
                                    <div class="w-8 h-8 image-fit">
                                        <img alt="Midone - HTML Admin Template" class="rounded-full" src="images/profile-14.jpg">
                                    </div>
                            ...
                            <a href="" class="flex items-center mt-2">
                                <div class="w-8 h-8 image-fit">
                                    <img alt="Midone - HTML Admin Template" class="rounded-full" src="images/preview-1.jpg">
                                </div>
                            ...
                            <a href="" class="flex items-center mt-2">
                                <div class="w-8 h-8 image-fit">
                                    <img alt="Midone - HTML Admin Template" class="rounded-full" src="images/preview-6.jpg">
                                </div>
                            ...
                            <a href="" class="flex items-center mt-2">
                                <div class="w-8 h-8 image-fit">
                                    <img alt="Midone - HTML Admin Template" class="rounded-full" src="images/preview-15.jpg">
                                </div>
        ...
        <!-- <div class="intro-x dropdown mr-4 sm:mr-6">
                    ...
                    <div class="notification-content pt-2 dropdown-menu">
                        <div class="notification-content__box dropdown-content">
                            ...
                            <div class="cursor-pointer relative flex items-center mt-5">
                                <div class="w-12 h-12 flex-none image-fit mr-1">
                                    <img alt="Midone - HTML Admin Template" class="rounded-full" src="images/profile-9.jpg">
                                    <div class="w-3 h-3 bg-success absolute right-0 bottom-0 rounded-full border-2 border-white"></div>
                                </div>
                                <div class="ml-2 overflow-hidden">
                                    <div class="flex items-center">
                ...
                <ul class="dropdown-content bg-primary/80 before:block before:absolute before:bg-black before:inset-0 before:rounded-md before:z-[-1] text-white">
                    <li class="p-2">
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            $enlace_pago = $row['enlace_pago'];
                            $enlace_telegram = $row['enlace_telegram'];
                            $ganancia = $row['ganancia'];
                            $trabajos_realizados = $row['realizados'];
                            $completados = $row['completados'];
                            $telefono = $row['telefono'];
                            $genero = $row['genero'];
                            // Accede a otras columnas si es necesario
                        }
                        $sql2 = "SELECT r.id, r.roles FROM usuarios_roles ur INNER JOIN roles r ON ur.rol_id=r.id WHERE ur.usuario_id =" . $_SESSION['userid'];


                        $res = $inigami->query($sql2);

                        while ($row = $res->fetch_assoc()) {
                            $rol_usuario[] = $row['roles'];
                            $rol_id = $row['id'];
                        }
                        // $inigami->dbConnect->close();
                        ?>
