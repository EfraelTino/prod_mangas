            ...
            <ul class="side-menu__sub-open">
                <li>
                    <a href="dashboard.php" class="side-menu">
                        ...
                        <div class="side-menu__title">Vista principal </div>
                    </a>
                </li>
                <?php
                if ($rol_id == 4 || $rol_id == 7) { ?>
                    <li>
                        <a href="agregar.php" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                            <div class="side-menu__title"> Registrar nuevo usuario </div>
                        </a>
                    </li>
                    <li>
                        <a href="serie.php" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                            <div class="side-menu__title"> Todas las series</div>
                        </a>
                    </li>
                <?php } else {
                    echo '';
                ...
                <li>
                    <a href="capitulos.php" class="side-menu">
                        <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                        <div class="side-menu__title">Capítulos y mangas</div>
                    </a>
                </li>
                <!-- <li>
